...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__AuditLog__5E5499A86A9C50B5");
        ...
        {
            entity.HasKey(e => e.BikeId).HasName("PK__Bicycle__7DC817C1841A0258");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__BicycleD__135C314D0F9B590E");

            entity.ToTable("BicycleDetail");

            entity.HasIndex(e => e.BikeId, "UQ__BicycleD__7DC817C031D28127").IsUnique();
        ...
        {
            entity.HasKey(e => e.ListingId).HasName("PK__BicycleL__BF3EBEF0553ABF2B");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__BikeType__516F0395D30EFB88");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brand__DAD4F3BE704C6671");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__ChatMess__C87C037CD06CC626");
        ...
        {
            entity.HasKey(e => e.SessionId).HasName("PK__ChatSess__C9F4927034AC28D8");
        ...
        {
            entity.HasKey(e => e.ConfigId).HasName("PK__Configur__C3BC333C477D669F");

            entity.ToTable("ConfigurationSystem");

            entity.HasIndex(e => e.ConfigKey, "UQ__Configur__4A306784977360D3").IsUnique();
        ...
        {
            entity.HasKey(e => e.DepositId).HasName("PK__Deposit__AB60DF517729F3AF");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF68C2D40CD");
        ...
        {
            entity.HasKey(e => e.ReportId).HasName("PK__Inspecti__D5BD48E5E84EC184");

            entity.ToTable("InspectionReport");

            entity.HasIndex(e => e.RequestId, "UQ__Inspecti__33A8519B5E5B7CD1").IsUnique();
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__Inspecti__33A8519AE30C777A");
        ...
        {
            entity.HasKey(e => e.MediaId).HasName("PK__ListingM__B2C2B5AF92BB683D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAFB35AB9AA");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A58A3DE900B");
        ...
        {
            entity.HasKey(e => e.PayoutId).HasName("PK__Payout__35C3DFAE2227B4D8");
        ...
        {
            entity.HasKey(e => e.RefreshTokenId).HasName("PK__RefreshT__F5845E598823380C");
        ...
        {
            entity.HasKey(e => e.ReportAbuseId).HasName("PK__ReportAb__A7AEDB953B0B1D57");

            entity.ToTable("ReportAbuse");

            entity.HasIndex(e => e.RequestAbuseId, "UQ__ReportAb__F18246D971F125EB").IsUnique();
        ...
        {
            entity.HasKey(e => e.RequestAbuseId).HasName("PK__RequestA__F18246D880FFDEEB");
        ...
        {
            entity.HasKey(e => e.FeeId).HasName("PK__ServiceF__B387B209E51752A7");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Shopping__51BCD797256DC060");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC9122F89A");

            entity.ToTable("User");

            entity.HasIndex(e => e.Username, "UQ__User__536C85E4EB3A411B").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__User__A9D10534EF9F8E82").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__UserProf__290C888459DE8D20");

            entity.ToTable("UserProfile");

            entity.HasIndex(e => e.UserId, "UQ__UserProf__1788CCADE349A437").IsUnique();
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__UserRole__8AFACE3AE3C3DAC9");
        ...
        {
            entity.HasKey(e => e.WishlistId).HasName("PK__Wishlist__233189CB97CB2E81");
